								...
								<?php foreach ($pegawai_list as $key) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pegawai/delete/').$key->id ?>" type="button" class="btn btn-danger" onCLick="JavaScript: return confirm('Anda Yakin Menghapus data?')">Delete</a>
										</td>
									</tr>
								<?php } ?>
								<tr>
									<a href="<?php echo site_url('pegawai/create/')?>" type="button" class="btn btn-info">Create Data</a>
